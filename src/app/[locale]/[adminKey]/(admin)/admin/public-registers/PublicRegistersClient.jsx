        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <div className="mt-1 text-sm text-white/60">
              รายการลงทะเบียนจาก Public Register (
            ...
            <table className="min-w-[1180px] w-full text-left text-sm">
              <thead className="bg-white/5 text-white/70">
                <tr>
                  ...
                  <th className="px-4 py-3">Course Date</th>
                ...
                {items.length === 0 ? (
                  ...
                  items.map((it) => (
                    <tr key={it._id} className="hover:bg-white/5">
                      ...
                      <td className="px-4 py-3">{it.coordinatorName || "-"}</td>
                      ...
                      <td className="px-4 py-3">{it.courseDateText || "-"}</td>
                      <td className="px-4 py-3">{it.traineeCount || 0}</td>
