    ...
    <>
      ...
      <section id="banner" className="mx-auto mt-24 max-w-7xl">
        <div className="relative overflow-hidden rounded-3xl">
          <Image
            src="/banner-desktop-the-next-humans-skills-TNHS.png"
        ...
        <div className="mx-auto w-full max-w-6xl px-6">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-1 lg:grid-cols-3 justify-items-center">
            <ProfileFlipCard
              ...
              intro="องค์กรที่มีความเชี่ยวชาญด้านสินทรัพย์ดิจิทัล เทคโนโลยีบล็อกเชน และ Web3 ที่มุ่งสร้างความเข้าใจเชิงลึกเกี่ยวกับ Digital Assets และโครงสร้างเศรษฐกิจดิจิทัลยุคใหม่"
            />
            <ProfileFlipCard
              ...
              intro="องค์กรที่มีความเชี่ยวชาญด้านเทคโนโลยีปัญญาประดิษฐ์ (AI) และ Data ที่เน้นการนำ AI และข้อมูลมาประยุกต์ใช้จริงในการทำงาน การตัดสินใจ และการเพิ่มประสิทธิภาพองค์กร"
            />
            <ProfileFlipCard
              ...
              intro="องค์กรที่มีความเชี่ยวชาญด้านการพัฒนาซอฟต์สกิล การพัฒนาศักยภาพบุคลากร และการยกระดับองค์กร เพื่อเสริมสร้างทักษะด้านความคิด การสื่อสารและภาวะผู้นำ"
            />
          </div>
        </div>
      </section>
